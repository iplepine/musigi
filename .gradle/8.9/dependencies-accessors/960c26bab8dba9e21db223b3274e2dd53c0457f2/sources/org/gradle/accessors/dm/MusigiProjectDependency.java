...
@NonNullApi
public class MusigiProjectDependency extends DelegatingProjectDependency {

    @Inject
    public MusigiProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
