...
public class DataProjectDependency extends DelegatingProjectDependency {
    ...
    /**
     * Creates a project dependency on the project at path ":data:media"
     */
    public Data_MediaProjectDependency getMedia() { return new Data_MediaProjectDependency(getFactory(), create(":data:media")); }
